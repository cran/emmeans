...
### C {#c}
  ...
  * CLDs
      * [Alternative](re-engineering-clds.html#alt-CLDs)
      * [For equivalence sets](re-engineering-clds.html#equiv-CLDs)
      * [For significance sets](re-engineering-clds.html#signif-CLDs)
      * [**multcompView** package](re-engineering-clds.html#CLDs)
      * [Principles](re-engineering-clds.html#CLDs)
      * [Re-engineered](re-engineering-clds.html#alt-CLDs)
      * [References](re-engineering-clds.html#refs)
      * [Relation to underlining](re-engineering-clds.html#underlining)
      * [Simulated example](re-engineering-clds.html#CLD-example)
  ...
  * [Compact letter displays (CLDs)](re-engineering-clds.html)
  * Comparison arrows
...
### E {#e}
  ...
  * [Equivalence sets (with CLDs)](re-engineering-clds.html#equiv-CLDs)
  ...
  * Examples
      ...
      * [CLDs (simulated)](re-engineering-clds.html#CLD-example)
      ...
      * `mtcars`
          * [in *basics: altering*](basics.html#altering)
...
### R {#r}
  ...
  * [`ref_grid()`](basics.html#ref_grid)
      ...
      * [`regrid` argument](transformations.html#regrid)
  ...
  * [`regrid()`](transformations.html#regrid)
      * [`regrid` vs. `type`](transformations.html#regrid)
...
### S {#s}
  ...
  * [Significance sets (with CLDs)](re-engineering-clds.html#signif-CLDs)
...
### U {#u}
  ...
  * [Underlining, grouping by](re-engineering-clds.html#underlining)
