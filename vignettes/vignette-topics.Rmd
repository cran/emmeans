...
### Jump to:  [#](##) [[](#[) [<](#<) [A](#a) [B](#b) [C](#c) [D](#d) [E](#e) [F](#f) [G](#g) [H](#h) [I](#i) [J](#j) [K](#k) [L](#l) [M](#m) [N](#n) [O](#o) [P](#p) [Q](#q) [R](#r) [S](#s) [T](#t) [U](#u) [V](#v) [W](#w) [X](#x) [Y](#y) [Z](#z)  {#topnav}


  * [## Link functions {#links}](transformations.html#regrid3)
  * [[Back to Contents](#contents)](transformations.html#regrid3)
  * <
      * [-- ](transformations.html#regrid3)


### # {##}


  * [a probability scale, and whatever link was used (say, probit) has already been](transformations.html#regrid3)
  * [accounted for, so is not "remembered" for possible later back-transformation. In](transformations.html#regrid3)
...
### B {#b}
  ...
  * [estimating marginal means will be averages of the probabilities in the reference](transformations.html#regrid3)
  * Examples
      ...
      * Logistic regression
          ...
          * [in *transformations: regrid3*](transformations.html#regrid3)
...
### C {#c}
  ...
  * [for getting estimates on a scale that is desired, but they also force](transformations.html#regrid3)
...
### D {#d}
  ...
  * [grid](transformations.html#regrid3)
...
### J {#j}
  ...
  * [models for ordinal data allow for a `"prob"` mode that produces estimates of](transformations.html#regrid3)
...
### M {#m}
  ...
  * [preempting any timing choices you might otherwise have made about handling the](transformations.html#regrid3)
  * [`print.summary_emm()`](basics.html#emmobj)
  * [probabilities for each ordinal level. The reference grid comprises estimates on](transformations.html#regrid3)
  * Probit regression
...
### O {#o}
  ...
  * [`regrid()` that takes place *at the time the reference grid is constructed*,](transformations.html#regrid3)
...
### P {#p}
  ...
  * [Similar things happen with certain options with multinomial models,](transformations.html#regrid3)
  ...
  * [so they will be different than what you would have obtained by keeping](transformations.html#regrid3)
  * [Some model classes provide special argument(s) (typically `mode`) that may cause](transformations.html#regrid3)
  * `specs`
      * [Formula](comparisons.html#formulas)
...
### Q {#q}
  ...
  * [that sense, when we use `mode = "prob"`, it is sort of like an implied call to](transformations.html#regrid3)
  * [the link scale.](transformations.html#regrid3)
  * [things on the link scale and then computing the probabilities after averaging on](transformations.html#regrid3)
  * [Too few means](AQuickStart.html#covar)
  * [transformation. If there are one or more factors that are averaged over in](transformations.html#regrid3)
  ...
  * [transformations or links to be handled early. For example, cumulative link](transformations.html#regrid3)
...
### V {#v}
  ...
  * [you to obtain marginal means of measurements already on that scale.](transformations.html#regrid3)
...
### W {#w}
  ...
  * [zero-inflated, or hurdle models. Those special modes are a great convenience](transformations.html#regrid3)
