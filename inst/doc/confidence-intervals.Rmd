...
[`help("summary.emm")`](../html/summary.emm.html) is worth a look.
...
test, where differences enough smaller than `delta` are the ones that can 
be significant.  The help page for `summary.emmGrid` gives the details of 
these tests.
