...
<!-- @index Prediction!Reference grid; Reference grids!Prediction on -->
...
fitted by `nlme::gls()` with some kind of inhomogeneous error structure. It may take
some effort, as well as a clear understanding of the model and its structure, to
obtain suitable SD estimates. It was sugegsted to me that the function
`easystats::get_variance()` may be helpful -- especially when working with
